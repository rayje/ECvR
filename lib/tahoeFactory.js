module.exports = {
	...
	getRunner: function(options) {
		...
		} else if (options.configAll) {
			return require('./tahoe/tahoeConfigAll')
		} else if (options.createAll) {
			return require('./tahoe/tahoeCreateAllStorageNodes')
		} else if (options.deleteAll) {
			return require('./tahoe/tahoeDeleteStorageNodes')
		}
